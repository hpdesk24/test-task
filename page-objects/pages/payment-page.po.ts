...
export class PaymentPage {
  ...
  readonly declineCardMessage = this.page.locator(
    '[role="alert"]:has-text("Your card has been declined.")'
  );
  ...
  async isDeclineCardMessageShown(): Promise<boolean> {
    await this.declineCardMessage.waitFor({
      state: "visible",
